<template>
    <div class="container">
        <div class="header">
            ...
            <div class="title">{{ $t('S_USDT_MANAGE') }}</div>
            <div class="right" />
        </div>
        <div class="body">
            <div class="content">
                <img src="/static/mobile/bank/no_bankcard.png" />
                <div class="text">{{ $t('S_NOT_BIND_USDT') }}</div>
            </div>
            <div class="btn-bind" @click="$router.push('/mobile/usdtAdd')">{{ $t('S_GO_BIND_USDT') }}</div>
        </div>
    </div>
</template>
